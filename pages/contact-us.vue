                    ...
                    <div class="col-lg-12 mt-2">
                      <label>
                        ...
                        <span style="margin-left: 10px">
                          ...
                          regarding products, services, and events.
                        </span>
                      </label>
                    </div>
  ...
  meta: [
    {
      name: "description",
      content:
        "Contact Sheffield Steel Systems for all your food service equipment, laundry and floor cleaning solutions.",
    },
    {
      name: "keywords",
      content:
        "Contact Sheffield Steel Systems, food service equipment, laundry solutions, floor cleaning solutions",
    },
  ],
});
...
const { value: request_type } = useField("request_type", null, {
  initialValue: "",
});
...
const { value: company_name } = useField("company_name", null, {
  initialValue: "",
});
const { value: business_type } = useField("business_type", null, {
  initialValue: "",
});
...
const { storeContact, validationErrors, isLoading } = {
  storeContact: async (contact) => {
    try {
  ...
  validationErrors: computed(() => {
    return Object.keys(errors.value).map((key) => {
