                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1 gallery-main-page-section">
                            ...
                            <DynamicFilters :items="products" filter-column="gallery_type" :filters="filters"
                                    ...
                                    <article class="entry entry-mask">
                                        <figure class="entry-media entry-gallery">
                                            <router-link :to="getBlogLink(product.id, product.name)">
                                                <NuxtImg :src="'/storage/' + product.main_image_path"
                                                    :alt="product.name" preset="cover" format="webp" quality="80"
                                ...
                                <div class="col-lg-12 mt-3">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <li v-for="(page, index ) in pagination?.links" :key="page.label"
                                                class="page-item" :class="{ active: page.active }">
                                                <a v-if="page.url && Number.isInteger(Number(page.label))"
                                                    class="page-link" @click.prevent="goToPage(page.url)">
                                                    {{ page.label }}
                                                </a>
                                            </li>
