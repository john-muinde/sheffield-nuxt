                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media entry-gallery">
                                            <router-link :to="getBlogLink(
                                                ...
                                                ">
                                                <NuxtImg :src="'/storage/' + post.main_image_path" :alt="product.name"
                                                    preset="cover" format="webp" quality="80" loading="lazy"
                                ...
                                <div class="col-md-12">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            <li v-for="page in generatePageLinks" :key="page" class="page-item" :class="{
                                                active:
                                                    page === currentPage,
                                            }">
