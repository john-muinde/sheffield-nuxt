                ...
                <div class="container mx-auto px-4">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1 media-video">
                            ...
                            <span class="relative">
                                <input v-model="searchTerm" type="text" placeholder="Search videos..."
                            ...
                            <ContentState v-if="!filteredVideos.length && !loading" type="empty"
                                content-type="videos" />
...
const fetchVideos = async () => {
    loading.value = true;
    try {
        const response = await api.get('/api/get-media-center-videos');
