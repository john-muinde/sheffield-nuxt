                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <ContentState v-if="!!error && !loading" type="error" :error-sub-message="error.message"
                                content-type="Brochures & Catalogs" @retry="fetchMediaCenter" />

                            <div v-show="brochures.length" id="dflip-books" ref="bookContainer"
                                class="dflip-books row media-center">
                                <a v-for="brochure in brochures" :id="`df_${brochure.id}`" :key="brochure.id"
