<template>
    <main class="main">
        ...
        <div>
            ...
            <!-- all props & events -->
            <vue-easy-lightbox esc-disabled :visible="visible" :imgs="imgs" :index="indexRef" @hide="handleHide" />
        </div>
                                    ...
                                    <div class="row">
                                        <div class="offset-lg-1 col-md-10 register-right mt-2">
                                            <div id="myTabContent" class="">
                                                <div id="home" class="" role="tabpanel" aria-labelledby="home-tab">
                                                    <form @submit.prevent="submitForm">
                                                        <div class="row register-form">
                                                            <div class="form-group col-md-6">
                                                                <label for="" class="label"><b>Name</b></label>
                                                                <input v-model="career.name" required type="text"
                                                                    class="form-control" placeholder="Name *" />
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="" class="label"><b>Phone Number</b></label>
                                                                <input v-model="career.phone_number" required
                                                                    type="text" class="form-control"
                                                                    placeholder="Phone Number *" />
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="" class="label"><b>Email</b></label>
                                                                <input v-model="career.email" required type="email"
                                                                    class="form-control" placeholder="Email *" />
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="" class="label"><b>Job
                                                                        Title/Position</b></label>
                                                                <input v-model="career.job_title" required type="text"
                                                                    class="form-control" placeholder="Job Title *" />
                                                            </div>

                                                            <div class="form-group col-md-12">
                                                                <label for="" class="label"><b>Message</b></label>
                                                                <textarea v-model="career.message" required
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="" class="label"><b>Supporting
                                                                        Document</b></label>
                                                                <input required type="file" class="form-control"
                                                                    placeholder="Supporting Document *" @change="
