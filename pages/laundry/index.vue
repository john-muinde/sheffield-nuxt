...
useHead({
  ...
  description:
    "We offer state of the art commercial laundry equipment for laundromats at Sheffield africa Ltd",
  keywords:
    "Laundry washer, commercial laundry equipment, commercial laundry machines in kenya, commercial laundry machines for sale in kenya, laundromats in nairobi",
});
...
const fetchMainSolutions = async () => {
  try {
    const response = await api.get("/api/get-solutions/247", {});
