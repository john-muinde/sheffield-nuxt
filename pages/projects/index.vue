                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 my-projects-section justify-content-center">
                        <div class="my-projects-carousel">
                            <carousel ref="scrollableContainerCarosel" v-model="currentSlide" class="carousel-wrapper"
                                :per-page="1" :breakpoints="breakpoints" :wrap-around="true"
                                :pause-autoplay-on-hover="true">
                                <slide v-for="(item, index) in projectsMenu" :key="index" data-toggle="tab"
                                    :href="'#' + item.title" role="tab" :aria-controls="item.title"
                                    aria-selected="false">
                    ...
                    <div class="col-lg-12 tab-content  mt-5 mb-5 pb-5">
                        ...
                        <div v-for="(segment, segmentIndex) in segmentsData" :id="segment.name" :key="segmentIndex"
                            class="tab-pane p-0 fade " :class="{ 'show active': segment.name === 'Hotels' }"
                            role="tabpanel" :aria-labelledby="segment.name">
                            <div class="main-clients">
                                <div class="clients-container mb-5 row ">
                                    <div class="col-md-10 offset-lg-1">
                                        <div class="row justify-content-center projects-row">
                                            <div v-for="(project, projectIndex) in segment.projects" :key="projectIndex"
                                                class="col-md-2 ">
                                                <article class="">
                                                    <figure class="">
                                                        <!-- <a href=""> -->
                                                        <img :src="'/storage/' + project.main_image_path"
                                                            alt="image desc" />
