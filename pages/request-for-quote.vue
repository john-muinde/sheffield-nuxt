                            ...
                            <form class="row" @submit.prevent="submitForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group">
                                                <vue-tel-input v-model="contact.phone_number" mode="international"
                                                    default-country="KE" :valid-characters-only="true" class="w-full" />
                                                <div class="mt-1 text-danger">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <multiselect v-model="contact.country" :options="countryOptions"
                                                :searchable="true" placeholder="Select country" label="name"
                                                track-by="name" selected-label="" select-label="" deselect-label="">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea id="request" v-model="contact.location" class="form-control"
                                                cols="30" rows="4" name="request"
                                ...
                                <aside class="col-lg-4">
                                    <div class="summary summary-cart">
                                                ...
                                                <div v-if="!cartItems.length"
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-gray-600 mb-4">
                                                            Explore our commercial kitchen solutions and find the
                                                            perfect
                                                        ...
                                                        <transition-group name="cart-item" tag="div" class="space-y-3">
                                                            <div v-for="(item, index) in cartItems" :key="item.id"
                                                                ...
                                                                <div class="flex items-center space-x-4">
                                                                    <img :src="'/storage/' + item.main_image_path"
                                                                        :alt="item.name"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="summary-shipping">
                                                    <td width="100%" style="min-width: 100%; width: 100%">
                                                        <div class="custom-control custom-radio">
                                                            <input id="deliver" v-model="contact.shipping" type="radio"
                                                ...
                                                <tr class="">
                                                    <td style="min-width: 100%; width: 100%">
                                                        <div class="custom-control custom-radio">
                                                            <input id="collect_from_sheffield"
                                                                v-model="contact.shipping" type="radio" name="shipping"
                                                                class="custom-control-input"
                                                                value="Collect from Sheffield" />
                                                            <label style="font-size: 1.4rem; font-weight: 450"
                                                                class="custom-control-label float-left text-dark"
                                                                for="collect_from_sheffield">Collect
                                                                from Sheffield
                                                            </label>
                                                        </div>
                                                        <div v-if="validationErrors?.shipping"
                                                            class="text-danger text-left w-full flex">
                                                            <div v-for="message in validationErrors?.shipping"
                                                                :key="message">
                                                                {{ message }}
                                                            </div>
                                                        </div>
                                                ...
                                                <tr class="summary-shipping">
                                                    <td width="100%" style="min-width: 100%; width: 100%">
                                                        <div class="custom-control custom-radio">
                                                            <input id="installation_yes" v-model="contact.installation"
                                                                type="radio" name="installation"
                                                ...
                                                <tr class="">
                                                    <td class="min-w-full w-full">
                                                        <div class="custom-control custom-radio">
                                                            <input id="installation_no" v-model="contact.installation"
                                                                type="radio" name="installation"
                                                        ...
                                                        <div v-if="validationErrors?.installation"
                                                            class="text-danger text-left w-full flex">
                                                            <div v-for="message in validationErrors?.installation"
                                                                :key="message">
                                                                {{ message }}
                                                            </div>
                                                        </div>
                                        ...
                                        <button type="submit" :disabled="isLoading || !cartItems.length"
