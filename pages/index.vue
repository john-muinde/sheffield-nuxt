                    ...
                    <div class="header-search header-search-extended header-search-visible d-none d-lg-block">
                        ...
                        <form action="#" method="get">
                            <div class="header-search-wrapper search-wrapper-wide searchListMainDiv">
                                ...
                                <input v-model="query" type="search" class="form-control" name="q" autocomplete="off"
                                    placeholder="Search product ..." required="" @input="search" />
                                <ul v-if="showResults" style="width: 370px">
                                    ...
                                    <li v-for="result in results" v-else :key="result.id">
                                        <NuxtLink :to="getProductLink(
                                            ...
                                            ">
                                            <img style="display: inline" width="28"
                                                :src="'/storage/' + result.main_image_path" class="rounded profile-img"
                                                alt="" />
                                            {{ result.name }}
                                        </NuxtLink>
                                    </li>
                        ...
                        <form action="#" method="get">
                            <div class="header-search-wrapper search-wrapper-wide searchListMainDiv">
                                ...
                                <input id="q" v-model="query" type="search" class="form-control" name="q"
                                    autocomplete="off" placeholder="Search product ..." required="" @input="search" />
    ...
    <div class="page-wrapper">
        <main class="main1 container">
            <div class="justify-content-center mt-4 home-design">
                <NuxtLink class="home-first home-section home-section-cat" to="/about-us/sheffield-advantage" as="a">
                    <div class="home-section-white">
                        <img src="/assets/images/homepage/sheffield_engineer.jpg" />
                    </div>
                </NuxtLink>

                <NuxtLink class="home-cold-storage home-section home-section-cat" to="cold-storage" as="a">
                    <div class="home-section-white">
                        <img src="/assets/images/homepage/cold_storage_home.jpg" alt="Commercial Cold Storage" />
                    </div>
                </NuxtLink>

                <NuxtLink class="home-kitchen home-section home-section-cat" to="/commercial-kitchen" as="a">
                    <div class="home-section-white">
                ...
                <NuxtLink class="home-laundry home-section home-section-cat" to="/laundry" as="a">
                    <div class="home-section-white">
                ...
                <NuxtLink class="home-last home-section home-section-cat" to="/projects" as="a">
                    <div class="home-section-white">
                ...
                <div class="container-fluid">
                    ...
                    ">
                            ...
                            <swiper :slides-per-view="slidesPerView" :space-between="20" :navigation="true"
                                ...
                                }" :slides-per-group="slidesPerView" class="products-container" @swiper="onSwiper">
    ...
    <template v-if="showPopup">
        <div class="popup-advert">
            <div class="popup-content">
                <img src="/assets/images/events/Rational Live 11 Dec.jpg" alt="Rotobake Ovens Solutions"
                    class="popup-image" style="width: 100%; min-height: 480px" />
                <div class="button-group row">
                    <button class="btn btn-primary btn-footer col-4" @click="dismissPopup">
                        Cancel
                    </button>
                    <button class="btn btn-secondary btn-footer col-4" @click="viewProduct()">
                        View
                    </button>
                </div>
            </div>
