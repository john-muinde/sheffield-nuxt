<template>
    <main class="main">
                                            ...
                                            <div class="banner video-banner-about"
                                                ...
                                                <div class="video-banner video-banner-bg bg-image text-center" style="">
                                                    <div class="container container-video-button"
                                                        ...
                                                        <a class="btn-video btn-iframe" @click="showVideoPopup
                                                    ...
                                                    <span class="view-sheffield" style="cursor: pointer;"><a class=""
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <carousel ref="scrollableContainerCarosel" class="carousel-wrapper" :per-page="1"
                                :autoplay="5000" :wrap-around="true" :pause-autoplay-on-hover="true"
        ...
        <div id="our-methodology-section" class="page-content pt-5 our-methodology-section" :style="{
        ...
        <div class="page-content pb-0 page-content-counter" :style="{
            ...
            <div ref="counterSection" class="container mt-0 counter-section"
                ...
                <div class="container">
                    <div class="container">
                        <div class="row pt-5 pb-5">
                            ...
                            <div ref="counterSection_people" class="col-md-6"
                                :class="{ visible: state.isSectionInView }">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-5 video-section">
                                    <div class="video-player">
                                        <video ref="videoPlayer" controls src="/assets/images/about-us/video/iCombi.mp4"
                                            loop></video>
                                ...
                                <div class="col-md-6 offset-md-1">
                                    ...
                                    <div class="my-carosel-section">
                                        <carousel ref="scrollableContainerCarosel" :items-to-show="4"
                                            class="carousel-wrapper" :per-page="1" :wrap-around="true"
                                            :pause-autoplay-on-hover="true" @load="adjustTheClass1Height">
                                            <slide v-for="(
                            item, index
                                                ...
                                                <div class="carousel-div-image">
                                                    ...
                                                    <div class="play-button">
                                                        ...
                                                        <input :id="'checkbox' +
                                                            index
                                                            " class="checkbox-play" type="checkbox" />
                                                    </div>
                                                </div>
                                            </slide>
                                            <template #addons>
