                        ...
                        <div class="col-md-10 offset-lg-1">
                            ...
                            <div class="row justify-content-left">
                                <div>
                                    ...
                                    <!-- all props & events -->
                                    <vue-easy-lightbox esc-disabled :visible="visible" :imgs="imgs" :index="indexRef"
                                        @hide="handleHide" />
                                </div>
                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <!-- <router-link
                                              ...
                                              "
                                          > -->
                                            <img style="" :src="'/storage/' + event.main_image_path" alt="image desc"
                                        ...
                                        <div class="entry-body pt-1">
                                            ...
                                            <div class="entry-content text-left">
                                                ...
                                                <a class="btn btn-primary btn-round mt-2 bottom-0" :href="event.url"
                                                    target="_blank">
                                                    Register
                                                </a>
