          ...
          <div class="row">
            ...
            <div class="col-lg-10 offset-lg-1">
              <p style="about-us-p" class="text-5 about-us-p">
                Sheffield hosts events at the Sheffield Academy and Our Facility
                based on the theme of experiential sessions so that you can
                interact with our solutions and network with like-minded
                industry players.<br />
            ...
            <div class="col-lg-10 offset-lg-1">
              <div class="row justify-content-left links-container mt-3">
                ...
                <div class="event-item">
                  ...
                  <div class="event-text mt-2">
                    <p>
                      The Rational Live Cooking sessions that take place twice a
                      month
                    </p>
                  </div>
                </div>
                  ...
                  <article class="entry entry-grid">
                    ...
                    <div class="entry-body pt-1">
                      ...
                      <div class="entry-content text-left">
                        ...
                        <a
                          class="btn btn-primary btn-round mt-2 bottom-0"
                          :href="event.url"
                          target="_blank"
                        >
                          Register
  ...
  meta: [
    {
      name: "description",
      content:
        "Sheffield hosts events at the Sheffield Academy and Our Facility based on the theme of experiential sessions so that you can interact with our solutions and network with like-minded industry players.",
    },
    {
      name: "keywords",
      content:
        "Events, Sheffield, Sheffield Academy, Sheffield Solutions, Sheffield Events, Sheffield Industry Players",
    },
  ],
});
...
const showSingle = (image) => {
  imgs.value = API_URL + "/storage/" + image;
  show();
};
