              ...
              <div class="invoice-content">
                <div class="invoice-detail-body">
                  <div class="invoice-detail-title">
                    <div class="invoice-logo">
                      <div class="upload pe-md-4">
                        ...
                        <img
                          v-if="selected_file"
                          :src="selected_file ? selected_file : '/assets/images/user-profile.jpeg'"
                          alt="profile"
                    ...
                    <div class="row justify-content-between">
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-4">
                          ...
                          <flat-pickr v-model="params.invoice_date" class="form-control form-control-sm flatpickr active" placeholder="Invoice Date" />
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group mb-4">
                          ...
                          <flat-pickr v-model="params.due_date" class="form-control form-control-sm flatpickr active" placeholder="Due Date" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="invoice-detail-items">
                    ...
                    <button type="button" class="btn btn-secondary additem btn-sm" @click="add_item()">
                      Add Item
                    </button>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group row invoice-created-by">
                          ...
                          <div class="col-sm-9">
                            <select id="payment-method-country" v-model="params.bank_info.country" class="country_code form-select form-select-sm">
                              <option value="">
                                Choose Country
                              </option>
                    ...
                    <div class="row">
                      ...
                      <div class="col-6">
                        <div v-if="selected_discount.value !== null" class="form-group mb-0 discount-amount">
                          ...
                          <input
                            v-model="selected_discount.value"
                            type="number"
                            min="0"
                            class="input-rate form-control"
                            placeholder="Rate"
              ...
              <div class="invoice-actions-btn">
                <div class="invoice-action-btn">
                  <div class="row">
                    ...
                    <div class="col-xl-12 col-md-4">
                      <router-link to="/apps/invoice/preview" class="btn btn-dark btn-preview">
                        Preview
                      </router-link>
                    </div>
                    <div class="col-xl-12 col-md-4">
