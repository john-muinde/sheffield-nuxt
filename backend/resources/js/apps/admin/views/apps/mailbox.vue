            ...
            <div class="mail-box-container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-12 mail-categories-container">
                    <perfect-scrollbar class="mail-sidebar-scroll">
                      <ul id="pills-tab" class="nav nav-pills d-block" role="tablist">
                        <li class="nav-item">
                      ...
                      <ul id="pills-tab2" class="nav nav-pills d-block group-list" role="tablist">
                        <li class="nav-item">
              ...
              <div id="mailbox-inbox" class="accordion mailbox-inbox">
                ...
                <div v-show="!selected_mail" class="message-box">
                  <perfect-scrollbar id="ct" class="message-box-scroll">
                    <div
                      v-for="(item, index) in filtered_mail_list"
                      :key="item.id + '' + index"
                      class="mail-item"
                ...
                <div v-if="selected_mail" class="content-box" :class="{ 'w-100 left-0': selected_mail }">
                  ...
                  <perfect-scrollbar class="content-scroll">
                    <div class="mail-content-container">
                          ...
                          <div class="f-body">
                            <div class="meta-title-tag">
                              <h4 v-if="selected_mail.first_name" class="mail-usr-name">
                                {{ selected_mail.first_name + " " + selected_mail.last_name }}
                              </h4>
                              <h4 v-else class="mail-usr-name">
                                {{ selected_mail.email }}
                              </h4>
                            </div>
                            <div class="meta-mail-time">
                      ...
                      <p v-if="selected_mail.first_name">
                        {{ selected_mail.first_name + " " + selected_mail.last_name }}
                      </p>
                      <p v-else>
                        {{ selected_mail.email }}
              ...
              <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content mailbox-popup">
                  ...
                  <div class="modal-footer">
                    ...
                    <button
                      v-if="mail_popup_type == 'add' || mail_popup_type == 'draft'"
                      type="button"
                      class="btn btn-success"
                      @click="save_mail('save')"
                    >
                      Save
                    </button>
                    <button
                      v-if="mail_popup_type == 'reply'"
                      type="button"
                      class="btn btn-success"
                      @click="save_mail('save_reply')"
                    >
                      Save Reply
                    </button>
                    <button
                      v-if="mail_popup_type == 'forward'"
                      type="button"
                      class="btn btn-success"
                      @click="save_mail('save_forward')"
                    >
                      Save Fwd
                    </button>
        ...
        if (ids.value.length) {
            ...
            for (let item of items) {
                ...
                //restore & permanent delete
                    ...
                    mail_list.value = mail_list.value.filter((d) => d.id != item.id);
