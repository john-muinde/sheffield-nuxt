      ...
      <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlMore">
                          ...
                          <template v-else>
                            ...
                            <li v-if="task.status == 'important'">
                              <a href="javascript:;" class="dropdown-item" @click="set_important(task)">Back to List</a>
                            </li>
                            <li v-else>
                              <a href="javascript:;" class="dropdown-item" @click="set_important(task)">Important</a>
                            </li>
        ...
        >
          <div class="modal-dialog modal-md modal-dialog-centered">
            <div v-if="selected_task" class="modal-content todolist-popup">
          ...
          <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content todolist-popup">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" @click="save_task()">
...
<script setup>
    ...
    const save_task = () => {
        ...
        let description_text = quillEditorData.value.getText();
