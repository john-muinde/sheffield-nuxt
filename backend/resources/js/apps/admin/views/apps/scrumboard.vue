<template>
  <div class="layout-px-spacing">
    ...
    <div id="cancel-row" class="row scrumboard">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="compose-box">
              <div id="addListModalTitle" class="compose-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="save_project()">
              {{ params.id ? "Update List" : "Add List" }}
            </button>
          </div>
        </div>
      </div>
    ...
    >
      <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">
              {{ params_task.task_id ? "Edit Task" : "Add Task" }}
            </h5>
            <button
              type="button"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            <div class="compose-box">
              <div id="addTaskModalTitle" class="compose-content">
                <div id="add_task_accordion" class="addTaskAccordion">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group mb-0">
                                ...
                                <textarea
                                  v-model="params_task.description"
                                  class="form-control"
                                  rows="5"
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              @click="save_task()"
            >
              {{ params_task.task_id ? "Update Task" : "Add Task" }}
            </button>
          </div>
        </div>
      </div>
    ...
    >
      <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content mailbox-popup">
          ...
          <div class="modal-body">
            <p class="">
              If you delete the task it will be gone forever. Are you sure you want to proceed?
            </p>
          </div>
          <div class="modal-footer">
            <button
...
<script setup>
    ...
    const initPopup = () => {
        addListModal.value = new window.bootstrap.Modal(document.getElementById('addListModal'));
        addTaskModal.value = new window.bootstrap.Modal(document.getElementById('addTaskModal'));
        deleteConformation.value = new window.bootstrap.Modal(document.getElementById('deleteConformation'));
    };
