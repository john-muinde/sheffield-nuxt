<template>
  <div class="layout-px-spacing">
    ...
    <div class="layout-px-spacing">
      <div id="cancel-row" class="row app-notes layout-top-spacing layout-spacing">
        <div class="col-lg-12">
          ...
          <div class="app-container">
            <div class="app-note-container">
              ...
              <div class="tab-title" :class="{ 'note-menu-show': is_show_note_menu }">
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-12 mt-5">
                    <ul id="pills-tab3" class="nav nav-pills d-block" role="tablist">
                      <li class="nav-item">
                    ...
                    <ul id="pills-tab" class="nav nav-pills d-block group-list" role="tablist">
                      <li class="nav-item">
              ...
              <div id="ct" class="note-container note-grid">
                <div
                  v-for="(note, index) in filterd_notes_list"
                  :key="index"
            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
              <div class="modal-content mailbox-popup">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" @click="save_note()">
...
<script setup>
    ...
    const initPopup = () => {
        notesMailModal.value = new window.bootstrap.Modal(document.getElementById('notesMailModal'));
    };
