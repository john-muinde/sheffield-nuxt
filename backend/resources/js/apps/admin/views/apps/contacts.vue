<template>
  <div class="layout-px-spacing app-contacts">
    ...
    <div id="cancel-row" class="row layout-spacing layout-top-spacing">
      <div class="col-lg-12">
        <div class="panel-body searchable-container" :class="[grid_type]">
          ...
          <div class="searchable-items" :class="[grid_type]">
            ...
            <div v-for="(user, index) in filterd_contacts_list" :key="index" class="items">
              <div class="item-content">
            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
              <div class="modal-content mailbox-popup">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" @click="save_user()">
...
<script setup>
    ...
    const initPopup = () => {
        addContactModal.value = new window.bootstrap.Modal(document.getElementById('addContactModal'));
    };
