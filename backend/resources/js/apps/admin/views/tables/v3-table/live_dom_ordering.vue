        ...
        <div class="panel br-6 p-0">
          <div class="custom-table">
            <v-client-table :data="items" :columns="columns" :options="table_option">
              <template #age="props">
                <input v-model="props.row.age" type="number" class="form-control form-control-sm" />
              </template>
              <template #position="props">
                <input v-model="props.row.position" type="text" class="form-control form-control-sm" />
              </template>
              <template #office="props">
                <select v-model="props.row.office" class="form-select form-select-sm">
