...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.rounded</code> class to create checkboxes rounded.
                  </p>

                  <div class="checkbox-default custom-control custom-checkbox rounded">
                    <input id="chkrd_default" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-primary custom-control custom-checkbox rounded">
                    <input id="chkrd_primary" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-success custom-control custom-checkbox rounded">
                    <input id="chkrd_success" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-info custom-control custom-checkbox rounded">
                    <input id="chkrd_info" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-warning custom-control custom-checkbox rounded">
                    <input id="chkrd_warning" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-danger custom-control custom-checkbox rounded">
                    <input id="chkrd_danger" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-secondary custom-control custom-checkbox rounded">
                    <input id="chkrd_secondary" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-dark custom-control custom-checkbox rounded">
                    <input id="chkrd_dark" type="checkbox" class="custom-control-input" />
...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.checkbox-outline-*</code> class to create checkboxes outlined and change different colors.
                  </p>

                  <div class="checkbox-outline-default custom-control custom-checkbox">
                    <input id="chkout_default" type="checkbox" class="custom-control-input" />
                    <label class="custom-control-label" for="chkout_default"> Default </label>
                  </div>
                  <div class="checkbox-outline-primary custom-control custom-checkbox">
                    <input id="chkout_primary" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-success custom-control custom-checkbox">
                    <input id="chkout_success" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-info custom-control custom-checkbox">
                    <input id="chkout_info" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-warning custom-control custom-checkbox">
                    <input id="chkout_warning" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-danger custom-control custom-checkbox">
                    <input id="chkout_danger" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-secondary custom-control custom-checkbox">
                    <input id="chkout_secondary" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-dark custom-control custom-checkbox">
                    <input id="chkout_dark" type="checkbox" class="custom-control-input" />
              ...
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  ...
                  <div class="checkbox-outline-default custom-control custom-checkbox rounded">
                    <input id="chkoutrd_default" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-primary custom-control custom-checkbox rounded">
                    <input id="chkoutrd_primary" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-success custom-control custom-checkbox rounded">
                    <input id="chkoutrd_success" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-info custom-control custom-checkbox rounded">
                    <input id="chkoutrd_info" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-warning custom-control custom-checkbox rounded">
                    <input id="chkoutrd_warning" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-danger custom-control custom-checkbox rounded">
                    <input id="chkoutrd_danger" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-secondary custom-control custom-checkbox rounded">
                    <input id="chkoutrd_secondary" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="checkbox-outline-dark custom-control custom-checkbox rounded">
                    <input id="chkoutrd_dark" type="checkbox" class="custom-control-input" />
...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.text-color</code> class to make text colored as checkbox.
                  </p>

                  <div class="row">
                    <div class="col-md-6 col-6">
                      <div class="checkbox-default custom-control custom-checkbox text-color">
                        <input id="chktc_default" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-primary custom-control custom-checkbox text-color">
                        <input id="chktc_primary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-success custom-control custom-checkbox text-color">
                        <input id="chktc_success" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-info custom-control custom-checkbox text-color">
                        <input id="chktc_info" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-warning custom-control custom-checkbox text-color">
                        <input id="chktc_warning" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-danger custom-control custom-checkbox text-color">
                        <input id="chktc_danger" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-secondary custom-control custom-checkbox text-color">
                        <input id="chktc_secondary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-dark custom-control custom-checkbox text-color">
                        <input id="chktc_dark" type="checkbox" class="custom-control-input" />
                    ...
                    <div class="col-md-6 col-6">
                      <div class="checkbox-outline-default custom-control custom-checkbox text-color">
                        <input id="chkouttc_default" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-primary custom-control custom-checkbox text-color">
                        <input id="chkouttc_primary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-success custom-control custom-checkbox text-color">
                        <input id="chkouttc_success" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-info custom-control custom-checkbox text-color">
                        <input id="chkouttc_info" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-warning custom-control custom-checkbox text-color">
                        <input id="chkouttc_warning" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-danger custom-control custom-checkbox text-color">
                        <input id="chkouttc_danger" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-secondary custom-control custom-checkbox text-color">
                        <input id="chkouttc_secondary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-dark custom-control custom-checkbox text-color">
                        <input id="chkouttc_dark" type="checkbox" class="custom-control-input" />
                  ...
                  <div class="row">
                    <div class="col-md-6 col-6">
                      <div class="checkbox-default custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_default" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-primary custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_primary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-success custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_success" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-info custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_info" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-warning custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_warning" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-danger custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_danger" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-secondary custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_secondary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-dark custom-control custom-checkbox text-color rounded">
                        <input id="chktcrd_dark" type="checkbox" class="custom-control-input" />
                    ...
                    <div class="col-md-6 col-6">
                      <div class="checkbox-outline-default custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_default" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-primary custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_primary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-success custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_success" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-info custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_info" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-warning custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_warning" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-danger custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_danger" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-secondary custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_secondary" type="checkbox" class="custom-control-input" />
                      ...
                      <div class="checkbox-outline-dark custom-control custom-checkbox text-color rounded">
                        <input id="chkouttcrd_dark" type="checkbox" class="custom-control-input" />
          ...
          <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.radio-*</code> class to change different colors.
                  </p>
...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.radio-classic</code> class to make classic.
                  </p>
...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.square-radio</code> class to make squares.
                  </p>
...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.radio-classic.text-color</code> class to make text colored as checkbox..
                  </p>
...
&lt;/div&gt;
            ...
            <div class="col-xl-12 col-12 layout-spacing">
              <div class="statbox panel box box-shadow">
                ...
                <div class="panel-body">
                  <p class="mb-4">
                    Use <code>.square-radio.text-color</code> class to make text colored as checkbox.
                  </p>
