              ...
              <div class="panel-body clipboard-copy-input">
                <div class="clipboard">
                  <form class="form-horizontal">
                    <input v-model="message1" class="form-control mb-4" />
          ...
          <div id="fclCopyTextarea" class="col-lg-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body clipboard-copy-textarea">
                <div class="clipboard">
                  <form class="form-horizontal">
                    <textarea v-model="message2" class="form-control mb-4" rows="3">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</textarea>
            ...
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body clipboard-copy-para">
                <div class="clipboard copy-txt">
                  <p class="otp-pass">
                    Here is your OTP <span>22991</span>.
                  </p>
                  <p class="mb-4">
          ...
          <div id="fclAdvance" class="col-lg-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body paragraph-advance">
                <div class="clipboard copy-txt">
                  <p class="mb-4">
                    Link -> <span>https://www.admin-dashboard.com/code</span>
                  </p>
