            ...
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code1')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code2')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code3')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code4')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code5')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-xl-12 col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code6')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code7')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code8')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code9')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code10')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code11')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code12')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code13')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code14')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code15')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code16')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code17')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code18')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code20')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code21')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code22')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code23')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="code-section-container show-code">
                  <button variant="default" class="toggle-code-snippet" @click="toggleCode('code24')">
                    <span>Code</span>
                  </button>
