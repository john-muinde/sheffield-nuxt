          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="form-group mb-0">
                  <flat-pickr v-model="date2" :config="{ enableTime: true, dateFormat: 'Y-m-d H:i' }" class="form-control flatpickr active" />
                </div>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="form-group mb-0">
                  <flat-pickr v-model="date3" :config="{ mode: 'range' }" class="form-control flatpickr active" />
                </div>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body">
                ...
                <div class="form-group mb-0">
                  <flat-pickr v-model="date4" :config="{ noCalendar: true, enableTime: true, dateFormat: 'H:i' }" class="form-control flatpickr active" />
                </div>
                      ...
                      <div class="row mt-4 mb-4">
                        <div class="col-lg-6 mb-3">
                          <select v-model="noui_min1" class="form-select w-100" @change="noui_change1(noui_min1, noui_max1)">
                            <option v-for="(i, index) in 61" :key="i" :value="index - 20">
                              {{ index - 20 }}
                            </option>
                          </select>
                        </div>
                        <div class="col-lg-6">
                          <input
                            ...
                            :max="40"
                            step="1"
                            @change="noui_change1(noui_min1, noui_max1)"
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div class="statbox panel box box-shadow">
                  ...
                  <div class="panel-body align-center">
                    <div class="container">
                      ...
                      <div class="row mt-4 mb-4">
                        <div class="col-lg-6">
                          <span class="example-val">{{ noui_min2 }} <span class="precentage-val">{{ noui_min2_perc }}%</span></span>
                        </div>
                        <div class="col-lg-6 text-end">
                          <span class="example-val">{{ noui_max2 }} <span class="precentage-val">{{ noui_max2_perc }}%</span></span>
                        </div>
                      </div>
                    </div>
