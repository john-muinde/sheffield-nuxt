        ...
        <div id="alertCustom" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              <div class="alert custom-alert-1 mb-4 alert-dismissible" role="alert">
                ...
                <div class="media mb-0">
                  ...
                  <div class="media-body">
                    ...
                    <div class="alert-btn">
                      <button type="button" class="btn btn-dismiss btn-default">
                        Accept
                      </button>
                    </div>
                  </div>
              ...
              <div class="code-section-container show-code">
                <button variant="default" class="toggle-code-snippet mb-3" @click="toggleCode('code6')">
                  <span>Code</span>
                </button>
...
&lt;/div&gt;
              ...
              <div class="code-section-container show-code">
                <button variant="default" class="toggle-code-snippet mb-3" @click="toggleCode('code7')">
                  <span>Code</span>
                </button>
...
&lt;/div&gt;
              ...
              <div class="code-section-container show-code">
                <button variant="default" class="toggle-code-snippet mb-3" @click="toggleCode('code8')">
                  <span>Code</span>
                </button>
