        ...
        <div id="buttonsRounded" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center split-buttons">
              <div class="row">
                <div class="col-lg-6">
                  <button type="button" class="btn btn-primary rounded-pill mb-2">
                    Primary
                  </button>
                </div>

                <div class="col-lg-6">
                  <button type="button" class="btn btn-outline-primary rounded-pill mb-2">
                    Primary
                  </button>
                </div>
              </div>
...
&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-primary rounded-pill mb-2&quot;&gt;Primary&lt;/button&gt;
        ...
        <div id="buttonsSolid" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center split-buttons">
              <button type="button" class="btn btn-primary mb-2 me-1">
                Primary
              </button>
              ...
              <button type="button" class="btn btn-warning mb-2 me-1">
                Warning
              </button>
        ...
        <div id="buttonsOutline" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center split-buttons">
              ...
              <button type="button" class="btn btn-outline-info mb-2 me-1">
                Info
              </button>
              <button type="button" class="btn btn-outline-success mb-2 me-1">
                Success
              </button>
              <button type="button" class="btn btn-outline-warning mb-2 me-1">
                Warning
              </button>
              <button type="button" class="btn btn-outline-danger mb-2 me-1">
                Danger
              </button>
              <button type="button" class="btn btn-outline-secondary mb-2 me-1">
                Secondary
              </button>
        ...
        <div id="buttonsSizes" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary btn-lg mb-4 me-2">
                Large button
              </button>
              <button type="button" class="btn btn-secondary mb-4 me-2">
                Default button
              </button>
              <button type="button" class="btn btn-warning btn-sm mb-4 me-2">
                Small button
              </button>
              <button type="button" class="btn btn-primary btn-sm mb-4 me-2" disabled>
                Disabled Button
              </button>
...
&lt;/button&gt;
        ...
        <div id="buttonsBlock" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary w-100 mb-4 me-2">
                Button
              </button>
              <button type="submit" class="btn btn-info w-100 mb-4 me-2">
                Button
              </button>
