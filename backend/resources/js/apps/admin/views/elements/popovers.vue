              ...
              <div class="row">
                <div class="col-lg-6">
                  <button
                    ...
                    data-bs-content="Tooltip on top"
                ...
                <div class="col-lg-6">
                  <button
                    ...
                    class="btn btn-danger mb-4 ms-2"
                  >
                    Popover on right
                  </button>
                </div>
                <div class="col-lg-6">
                  <button
                    ...
                    data-bs-content="Tooltip on bottom"
                    class="btn btn-warning mb-4 ms-2"
                  >
                    Popover on bottom
                  </button>
                </div>
                <div class="col-lg-6">
                  <button
                    ...
                    data-bs-toggle="popover"
                    data-bs-placement="left"
                    data-bs-content="Tooltip on left"
              ...
              <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                  <button
                    ...
                    data-bs-content="Disabled Animation"
                    class="btn btn-dark"
                  >
                    Disabled Animation
                  </button>
