        ...
        <div id="badgeCustom" class="col-lg-12 mx-auto layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              ...
              <button class="btn btn-dark mt-3 mb-3 ms-2">
                Notifications<span class="badge badge-light ms-2">4</span>
              </button>

              <span class="badge badge-warning badge-chip mt-3 mb-3 ms-2 position-relative">
                <img
                  src="/assets/images/delete-user-4.jpeg"
                  alt="Person"
                  width="96"
                  height="96"
                />
              ...
              <span class="badge badge-danger badge-chip mt-3 mb-3 ms-2">
                <img
                  src="/assets/images/delete-user-17.jpeg"
                  alt="Person"
                  width="96"
                  height="96"
                />
