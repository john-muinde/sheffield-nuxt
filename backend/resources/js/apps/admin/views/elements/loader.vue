        ...
        <div id="loaderWith-buttons" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              ...
              <button type="button" class="btn btn-danger btn-lg mb-3 me-3">
                <span class="spinner-border text-white me-2 align-self-center loader-sm">Loading...</span> Loading
              </button>
              <button type="button" class="btn btn-secondary btn-lg mb-3 me-3">
                <span class="spinner-grow text-white me-2 align-self-center loader-sm">Loading...</span> Loading
              </button>
          ...
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <div class="d-flex justify-content-between mx-5 mt-3 mb-5">
                ...
                <div class="spinner-border text-success align-self-center">
                  Loading...
                </div>
                <div class="spinner-border text-success align-self-center loader-sm">
                  Loading...
                </div>
              </div>

              <div class="d-flex justify-content-between mx-5 mt-3 mb-5">
                <div class="spinner-border spinner-border-reverse align-self-center loader-lg text-secondary">
                  Loading...
                </div>
              ...
              <div class="d-flex justify-content-between mx-5 mt-3">
                ...
                <div class="spinner-grow text-info align-self-center">
                  Loading...
                </div>
                <div class="spinner-grow text-info align-self-center loader-sm">
                  Loading...
                </div>
              </div>
          ...
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <div class="d-flex justify-content-between mx-5 mt-3 mb-5">
                ...
                <div class="spinner-border text-danger align-self-center">
                  Loading...
                </div>
                <div class="spinner-border text-warning align-self-center">
                  Loading...
                </div>
              ...
              <div class="d-flex justify-content-between mx-5 mt-3 mb-5">
                <div class="spinner-border spinner-border-reverse align-self-center text-dark">
                  Loading...
                </div>
                <div class="spinner-border spinner-border-reverse align-self-center text-secondary">
                  Loading...
                </div>
                <div class="spinner-border spinner-border-reverse align-self-center text-primary">
                  Loading...
                </div>
                <div class="spinner-border spinner-border-reverse align-self-center text-danger">
                  Loading...
                </div>
              </div>
              ...
              <div class="d-flex justify-content-between mx-5 mt-3 mb-5">
                ...
                <div class="spinner-grow text-danger align-self-center">
                  Loading...
                </div>
                <div class="spinner-grow text-secondary align-self-center">
                  Loading...
                </div>
                <div class="spinner-grow text-warning align-self-center">
                  Loading...
                </div>
              </div>
