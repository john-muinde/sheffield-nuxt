                ...
                >
                  ...
                  <tbody role="rowgroup">
                    ...
                    >
                      ...
                      <td aria-colindex="4" role="cell" class="">
                        <p :class="i == 3 ? 'text-success' : 'text-danger'">
                          {{ item.sales + "%" }}
                        </p>
                      </td>
                      <td aria-colindex="5" role="cell" class="text-center">
          ...
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              <div class="contextual-table table-responsive">
                <table id="__BVID__337" role="table" class="table b-table">
                  <thead role="rowgroup" class="">
                    <tr role="row" class="">
                  ...
                  <tbody role="rowgroup">
                    <tr
                      v-for="(item, i) in table_2"
                      :key="item.name"
                      role="row"
                      :class="'table-' + random_class(i)"
                    >
                      <td role="cell" class="">
                        {{ i + 1 }}
                      </td>
...
&lt;/div&gt;
        ...
        <div id="tableDropdown" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table id="__BVID__345" role="table" class="table b-table table-bordered">
                  <thead role="rowgroup" class="">
                    <tr role="row" class="">
                      <th role="columnheader" scope="col" class="">
                        Name
                  ...
                  <tbody role="rowgroup">
                    ...
                    >
                      ...
                      <td role="cell" class="text-center">
                        <div id="__BVID__464" class="dropdown b-dropdown custom-dropdown btn-group">
                          <a
                            id="ddlcustom"
                            aria-haspopup="true"
                            aria-expanded="false"
                      ...
                      >
                        <div class="checkbox-primary custom-control custom-checkbox">
                          <input
                            ...
                            value="true"
                          /><label class="custom-control-label" for="__BVID__372"></label>
                        </div>
                      </th>
                      <th
                        role="columnheader"
