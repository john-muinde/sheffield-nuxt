        ...
        <div class="widget widget-revenue">
          ...
          <div class="widget-content">
            <div class="chart-title">
              Total Profit <span class="text-primary ms-1">$10,840</span>
            </div>
            <apexchart
      ...
      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-transaction">
          ...
          <div class="widget-content">
            ...
            <div class="transactions-list">
              <div>
                <span class="b-avatar icon-fill-warning me-2 badge-warning rounded-circle">
                  <span class="b-avatar-custom"><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="19"
                    height="19"
                    viewBox="0 0 24 24"
            ...
            <div class="transactions-list">
              <div>
                <span class="b-avatar icon-fill-danger me-2 badge-danger rounded-circle"><span class="b-avatar-text"><span>AD</span></span></span>
                <div class="t-name">
                  <h4>Amy Diaz</h4>
                  <p>31 Jan 1:00PM</p>
                </div>
            ...
            <div class="transactions-list">
              <div>
                <span class="b-avatar icon-fill-secondary me-2 badge-secondary rounded-circle"><span class="b-avatar-custom"><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="19"
                  height="19"
                  viewBox="0 0 24 24"
                ...
                >
                  <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                  <polyline points="9 22 9 12 15 12 15 22" /></svg></span></span>
                <div class="t-name">
                  <h4>Netflix</h4>
                  <p>02 Feb 1:00PM</p>
                </div>
            ...
            <div class="transactions-list">
              <div>
                <span class="b-avatar icon-fill-info me-2 badge-info rounded-circle"><span class="b-avatar-text"><span>DA</span></span></span>
                <div class="t-name">
            ...
            <div class="transactions-list">
              <div>
                <span class="b-avatar icon-fill-danger me-2 badge-danger rounded-circle"><span class="b-avatar-text"><span>OG</span></span></span>
                <div class="t-name">
                  <h4>Oscar Garner</h4>
                  <p>20 Feb 1:00PM</p>
                </div>
          ...
          <div class="widget-amount">
            <div class="w-a-info funds-received me-3">
              <span>Received
                ...
                >
                  <polyline points="18 15 12 9 6 15" /></svg></span>
              <p>$97.99</p>
            </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="td-content">
                      <img src="/assets/images/profile-13.jpeg" alt="avatar" /><span>Luke Ivory</span>
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="td-content">
                      <img src="/assets/images/profile-7.jpeg" alt="avatar" /><span>Andy King</span>
                    </div>
                  </td>
                  <td>
                    <div class="td-content text-warning">
                      Nike Sport
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="td-content">
                      <img src="/assets/images/profile-10.jpeg" alt="avatar" /><span>Laurie Fox</span>
                    </div>
                  </td>
                  <td>
                    <div class="td-content text-danger">
                      Sunglasses
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="td-content">
                      <img src="/assets/images/profile-5.jpeg" alt="avatar" /><span>Ryan Collins</span>
                    </div>
                  </td>
                  <td>
                    <div class="td-content text-warning">
                ...
                <tr>
                  <td>
                    <div class="td-content">
                      <img src="/assets/images/profile-4.jpeg" alt="avatar" /><span>Irene Collins</span>
                    </div>
                  </td>
                  <td>
                    <div class="td-content text-primary">
                ...
                <tr>
                  <td>
                    <div class="td-content">
                      <img src="/assets/images/profile-11.jpeg" alt="avatar" /><span>Sonia Shaw</span>
                    </div>
                  </td>
                  <td>
                    <div class="td-content text-danger">
          ...
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
            <div class="widget">
              ...
              <div class="widget-content">
                <div class="w-chart">
                  <apexchart
                    v-if="referral_options"
                    height="160"
                    type="area"
                    :options="referral_options"
                    :series="referral_series"
                  />
                </div>
              </div>
            </div>
            ...
            <div class="w-action">
              ...
              <div class="read-more">
                <a href="javascript:void(0);">Read More
                  ...
                  >
                    <polyline points="13 17 18 12 13 7" />
                    <polyline points="6 17 11 12 6 7" /></svg></a>
              </div>
            </div>
          </div>
        </div>
