                                ...
                                <div class="d-sm-flex d-block">
                                  <div class="form-group me-1">
                                    <select v-model="ddl_1" class="form-select">
                                      ...
                                      <option v-for="item in 30" :key="item" :value="item">
                                        {{ item }}
                                      </option>
                                    </select>
                                  </div>
                                  ...
                                  <div class="form-group me-1">
                                    <select v-model="ddl_3" class="form-select">
                                      ...
                                      <option v-for="item in 42" :key="2022 - item" :value="2022 - item">
                                        {{ 2022 - item }}
                                      </option>
                                    </select>
                                  </div>
                ...
                <div class="info">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-end mb-5">
                      <button id="add-work-platforms" type="button" class="btn btn-primary">
                        Add
                      </button>
                    </div>
                    <div class="col-md-11 mx-auto">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="country" v-model="ddl_6" class="form-select w-100">
                              <option value="all">
                                All Countries
                              </option>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input id="location" class="form-control mb-4" placeholder="Location" />
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input id="website1" class="form-control mb-4" placeholder="Write your website here" />
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="col-md-11 mx-auto">
                            <div class="input-form">
                              <input
                                ...
                                class="form-control"
                              />
                              <button id="add-skills" type="button" class="btn btn-primary">
                                Add
                              </button>
                            </div>
                          </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
              <form id="work-experience" class="section work-experience">
                <div class="info">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-end mb-5">
                      <button id="add-work-exp" type="button" class="btn btn-primary">
                        Add
                      </button>
                    </div>
                    <div class="col-md-11 mx-auto">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input id="degree3" class="form-control mb-4" placeholder="Add your work here" />
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="degree4">Location</label>
                                  <input id="degree4" class="form-control mb-4" placeholder="Add your work here" />
                                </div>
                              </div>
                            </div>
                          </div>
