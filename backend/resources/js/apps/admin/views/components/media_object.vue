          ...
          <div id="mediaObjectNesting" class="col-lg-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body nesting">
                <div class="media">
                  <div class="media-aside align-self-start">
                    <img src="/assets/images/profile-3.jpeg" alt="pic1" class="meta-usr-img rounded" />
                  </div>
                  <div class="media-body">
                    <h4 class="media-heading">
                      Heading
                    ...
                    <div class="media mt-4">
                      <div class="media-aside align-self-start">
                        <img src="/assets/images/profile-4.jpeg" alt="pic2" class="rounded" />
                      </div>
                      <div class="media-body">
                        <h4 class="media-heading">
                          Heading
          ...
          <div id="mediaObjectNotationText" class="col-lg-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body notation-text">
                <div class="media">
                  <div class="media-aside align-self-start">
                    <img src="/assets/images/profile-4.jpeg" alt="pic1" class="meta-usr-img rounded" />
                  </div>
                  <div class="media-body">
                    <h4 class="media-heading">
                      Heading
                    ...
                    <div class="media-notation">
                      <a href="javascript:void(0);"> Reply </a><a href="javascript:void(0);"> Edit </a><a href="javascript:void(0);"> Delete </a>
                    </div>
                  </div>
                </div>
            ...
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body m-o-label">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h4 class="media-heading">
                      <span class="media-title"> Heading</span><span class="badge badge-primary">Web Designer</span>
                    </h4>
                    <p class="media-text">
                      Sed dapibus nulla elementum, rutrum neque eu, gravida neque. Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean dignissim sed ante eget dapibus.
                    </p>
            ...
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body m-o-chkbox">
                ...
                <div class="media">
                  <div class="media-aside align-self-start">
                    <div class="checkbox-dark custom-control custom-checkbox">
                      <input id="chk2" type="checkbox" class="custom-control-input" /><label class="custom-control-label" for="chk2"></label>
                    </div>
                  </div>
                  ...
                  <div class="media-aside align-self-start">
                    <div class="radio-classic radio-dark custom-control custom-radio">
                      <input
                        ...
                        class="custom-control-input"
                        value="radio-1"
                      /><label class="custom-control-label" for="rdo1"></label>
                    </div>
                  </div>
                  <div class="media-body">
                    <h4 class="media-heading">
                  ...
                  <div class="media-aside align-self-start">
                    <div class="radio-classic radio-dark custom-control custom-radio">
                      <input
                        ...
                        class="custom-control-input"
                        value="radio-2"
                      /><label class="custom-control-label" for="rdo2"></label>
                    </div>
                  </div>
                  <div class="media-body">
                    <h4 class="media-heading">
