        ...
        <div id="sweetalertbasic" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(1)">
                Basic message
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code1')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertmessage" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(2)">
                Success message!
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code2')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertdynamic" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(3)">
                Dynamic queue
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code3')">
                  <span>Code</span>
                </button>
    ...
    preConfirm: () =&gt; {
        ...
        <div id="sweetalertatitlewithtext" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(4)">
                Title & text
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code4')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertchainingmodals" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(5)">
                Chaining modals (queue)
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code5')">
                  <span>Code</span>
                </button>
    ...
    new window.Swal.fire({
        ...
        <div id="sweetalertanimation" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(6)">
                Custom animation
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code6')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertautoclosetimer" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(7)">
                Message timer
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code7')">
                  <span>Code</span>
                </button>
    ...
    if (result.dismiss === new window.Swal.DismissReason.timer) {
        ...
        <div id="sweetalertcustomimage" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(8)">
                Message with custom image
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code8')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertcustomhtml" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(9)">
                Custom Description & buttons
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code9')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertwarningmessage" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(10)">
                Confirm
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code10')">
                  <span>Confirm</span>
                </button>
    ...
    if (result.value) {
        ...
        <div id="sweetalertcancel" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(11)">
                Addition else for "Cancel".
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code11')">
                  <span>Code</span>
                </button>
    ...
    .then(result =&gt; {
        ...
        <div id="sweetalertcustomstyle" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(12)">
                Custom Message
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code12')">
                  <span>Code</span>
                </button>
    ...
    background: '#fff url(' + '/assets/images/sweet-bg.jpg' + ') no-repeat 100% 100%'
        ...
        <div id="sweetalertfooter" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(13)">
                With Footer
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code13')">
                  <span>Code</span>
                </button>
    ...
    padding: '2em'
        ...
        <div id="sweetalertrtl" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(14)">
                RTL
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code14')">
                  <span>Code</span>
                </button>
    ...
    target: document.getElementById('rtl-container')
        ...
        <div id="sweetalertmixin" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary me-2 btn" @click="showAlert(15)">
                Mixin
              </button>
              <div class="code-section-container show-code">
                <button class="btn btn-default toggle-code-snippet" @click="toggleCode('code15')">
                  <span>Code</span>
                </button>
