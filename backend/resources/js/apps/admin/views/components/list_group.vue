          ...
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              ...
              <div class="code-section-container show-code">
                <button type="button" class="btn btn-deafult toggle-code-snippet" @click="toggleCode('code1')">
                  <span>Code</span>
                </button>
        ...
        <div id="listGroupLinks" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              ...
              <div class="code-section-container show-code">
                <button type="button" class="btn btn-deafult toggle-code-snippet" @click="toggleCode('code2')">
                  <span>Code</span>
                </button>
        ...
        <div id="listGroupIcons" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              ...
              <div class="code-section-container show-code">
                <button type="button" class="btn btn-deafult toggle-code-snippet" @click="toggleCode('code3')">
                  <span>Code</span>
                </button>
        ...
        <div id="listGroupImages" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              ...
              <div class="code-section-container show-code">
                <button type="button" class="btn btn-deafult toggle-code-snippet" @click="toggleCode('code4')">
                  <span>Code</span>
                </button>
        ...
        <div id="listGroupTask" class="col-lg-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              ...
              <div class="code-section-container show-code">
                <button type="button" class="btn btn-deafult toggle-code-snippet" @click="toggleCode('code5')">
                  <span>Code</span>
                </button>
