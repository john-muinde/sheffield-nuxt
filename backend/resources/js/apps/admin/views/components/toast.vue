        ...
        <div id="toastBasic" class="col-lg-12 col-12 position-relative layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body">
              <button type="button" class="btn btn-primary" @click="toastBasic.show()">
                Open Toast
              </button>
        ...
        <div id="toastTopLeft" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-success" @click="toastTopLeft.show()">
                Top Left
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastTopCenter" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-info" @click="toastTopCenter.show()">
                Top Center
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastTopRight" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-danger" @click="toastTopRight.show()">
                Top Right
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastBottomLeft" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-warning" @click="toastBottomLeft.show()">
                Bottom Left
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastBottomCenter" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-secondary" @click="toastBottomCenter.show()">
                Bottom Center
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastBottomRight" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-dark" @click="toastBottomRight.show()">
                Bottom Right
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastNoAction" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-warning" @click="toastNoAction.show()">
                No Action
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastActionText" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-primary" @click="toastActionText.show()">
                Action Text
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastTextColor" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-danger" @click="toastTextColor.show()">
                Text Color
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastClickCallback" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-info" @click="toastClickCallback.show()">
                Click Callback
              </button>
              ...
              >
                <div class="toast-body toast-dark d-flex justify-content-between">
                  ...
                  <a
                    ...
                    data-bs-dismiss="toast"
                    @click="toastClickCallback1.show()"
                  >DISMISS</a>
                </div>
              </div>
              <!-- callback  toast-->
...
&lt;/div&gt;
        ...
        <div id="toastDuration" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <button type="button" class="btn btn-dark" @click="toastDuration.show()">
                Duration
              </button>
...
&lt;/div&gt;
        ...
        <div id="toastBackgroundColor" class="col-lg-12 col-12 layout-spacing">
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center">
              <!-- Primary -->
              <button type="button" class="btn btn-primary mb-2 mx-1" @click="toastPrimary.show()">
                Primary
              </button>
              <div
                ref="toastPrimary"
              ...
              <!-- Info -->
              <button type="button" class="btn btn-info mb-2 mx-1" @click="toastInfo.show()">
                Info
              </button>
              <div
                ref="toastInfo"
              ...
              <!-- Success -->
              <button type="button" class="btn btn-success mb-2 mx-1" @click="toastSuccess.show()">
                Success
              </button>
              <div
                ref="toastSuccess"
              ...
              <!-- Warning -->
              <button type="button" class="btn btn-warning mb-2 mx-1" @click="toastWarning.show()">
                Warning
              </button>
              <div
                ref="toastWarning"
              ...
              <!-- Danger -->
              <button type="button" class="btn btn-danger mb-2 mx-1" @click="toastDanger.show()">
                Danger
              </button>
              <div
                ref="toastDanger"
              ...
              <!-- Dark -->
              <button type="button" class="btn btn-dark mb-2 mx-1" @click="toastDark.show()">
                Dark
              </button>
              <div
                ref="toastDark"
