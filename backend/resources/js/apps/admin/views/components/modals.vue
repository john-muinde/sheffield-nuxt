          ...
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center modal-video">
              ...
              >
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div id="modalYoutubeLabel" class="modal-header p-0 border-0">
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div id="modalVimeoLabel" class="modal-header p-0 border-0">
                      <button
                        type="button"
                        class="btn-close ms-auto mb-1"
                        data-dismiss="modal"
            ...
            <div class="panel-body text-center">
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <button
                    ...
                    class="btn btn-info mb-2 me-2"
                    data-bs-toggle="modal"
                    data-bs-target="#rotateleftModal"
                  >
                    RotateIn Left
                  </button>
                </div>
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="fadeinModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="slidedownModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="slideupModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="fadeupModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="rotateleftModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="fadeleftModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="zoomupModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="faderightModalLabel" class="modal-title">
                        Modal title
                      </h5>
                      <button
                        type="button"
          ...
          <div class="statbox panel box box-shadow">
            ...
            <div class="panel-body text-center advance-content signinModal-content">
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <ul id="simpletab" class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item">
                          <a
                            id="home-tab"
                ...
                <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <p class="mt-2">
                        Click on view to access your profile.
                      </p>
                    </div>
              ...
              >
                <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    <div id="loginModalLabel" class="modal-header">
              ...
              >
                <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    <div id="registerModalLabel" class="modal-header">
                      <h4 class="modal-title">
                        Register
                      </h4>
                      <button
