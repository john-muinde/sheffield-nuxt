          ...
          <div id="tabsSimple" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body simple-tab tabs">
                <ul id="simpletab" class="nav nav-tabs mb-3 mt-3" role="tablist">
                  <li class="nav-item">
                    <a
                      id="home-tab"
                ...
                <div id="simpletabContent" class="tab-content">
                  <div
                    id="home"
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code1')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body simple-pills tabs">
                <ul id="pills-tab" class="nav nav-pills mb-3 mt-3" role="tablist">
                  <li class="nav-item">
                    <a
                      id="pills-home-tab"
                      class="nav-link active"
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code2')">
                    <span>Code</span>
                  </button>
          ...
          <div id="tabsIcons" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body icon-tab tabs">
                <ul id="iconTab" class="nav nav-tabs mb-3 mt-3" role="tablist">
                  <li class="nav-item">
                    <a
                      id="icon-home-tab"
                      class="nav-link active"
                ...
                <div id="iconTabContent-1" class="tab-content">
                  <div
                    id="icon-home"
                    class="tab-pane fade show active"
                    role="tabpanel"
                  ...
                  <div id="icon-profile" class="tab-pane fade" role="tabpanel">
                    <div class="media">
                      <img class="me-3" src="/assets/images/profile-32.jpeg" alt="Generic placeholder image" />
                      <div class="media-body">
                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code3')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body icon-pill tabs">
                <ul id="icon-pills-tab" class="nav nav-pills mb-3 mt-3" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="icon-pills-tabContent" class="tab-content">
                  <div
                    id="icon-pills-home"
                    class="tab-pane fade show active"
                    role="tabpanel"
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code4')">
                    <span>Code</span>
                  </button>
              ...
              <div class="panel-body vertical-border-pill tabs">
                <div class="row mb-4 mt-3">
                  ...
                  <div class="col-sm-9 col-12">
                    <div id="v-border-pills-tabContent" class="tab-content">
                      <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code5')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body border-tab tabs">
                <ul id="border-tabs" class="nav nav-tabs mt-3" role="tablist">
                  <li class="nav-item">
                    <a
                      id="border-home-tab"
                      class="nav-link active"
                ...
                <div id="border-tabsContent" class="tab-content mb-4">
                  <div
                    id="border-home"
                    class="tab-pane fade show active"
                    role="tabpanel"
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code6')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body border-top-tab tabs">
                <ul id="borderTop" class="nav nav-tabs mb-3 mt-3" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code7')">
                    <span>Code</span>
                  </button>
          ...
          <div id="tabsLine" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body underline-content tabs">
                <ul id="lineTab" class="nav nav-tabs mb-3" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="lineTabContent-3" class="tab-content">
                  <div
                    id="underline-home"
                    class="tab-pane fade show active"
                    role="tabpanel"
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code8')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body animated-underline-content tabs">
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code9')">
                    <span>Code</span>
                  </button>
            ...
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body vertical-line-pill tabs">
                <div class="row mb-4 mt-3">
                  ...
                  <div class="col-sm-9 col-12">
                    <div id="v-line-pills-tabContent" class="tab-content">
                      <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code10')">
                    <span>Code</span>
                  </button>
          ...
          <div id="tabsAlignments" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body justify-tab tabs">
                <ul id="justifyTab" class="nav nav-tabs mb-3 mt-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <a
                      id="justify-home-tab"
                      class="nav-link active"
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code11')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body justify-pill tabs">
                <ul id="justify-pills-tab" class="nav nav-pills mb-3 mt-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="justify-pills-tabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code12')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body tab-justify-centered tabs">
                <ul id="justifyCenterTab" class="nav nav-tabs mb-3 mt-3 justify-content-center" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="justifyCenterTabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code13')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body pill-justify-centered tabs">
                <ul id="justify-center-pills-tab" class="nav nav-pills mb-3 mt-3 justify-content-center" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="justify-center-pills-tabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code14')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body tab-justify-right tabs">
                <ul id="justifyRightTab" class="nav nav-tabs mb-3 mt-3 justify-content-end" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="justifyRightTabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code15')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body pill-justify-right tabs">
                <ul id="justify-right-pills-tab" class="nav nav-pills mb-3 mt-3 justify-content-end" role="tablist">
                  <li class="nav-item">
                    <a
                ...
                <div id="justify-right-pills-tabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code16')">
                    <span>Code</span>
                  </button>
          ...
          <div id="tabsWithIcons" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body rounded-pills-icon tabs">
                <ul id="rounded-pills-icon-tab" class="nav nav-pills mb-4 mt-3 justify-content-center" role="tablist">
                ...
                <div id="rounded-pills-icon-tabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code17')">
                    <span>Code</span>
                  </button>
          ...
          <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body rounded-circle-pills-icon tabs">
                <ul id="rounded-circle-pills-icon-tab" class="nav nav-pills mb-4 mt-3 justify-content-center" role="tablist">
                ...
                <div id="rounded-circle-pills-icon-tabContent" class="tab-content">
                  <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code18')">
                    <span>Code</span>
                  </button>
              ...
              <div class="panel-body rounded-vertical-pills-icon tabs">
                <div class="row mb-4 mt-3">
                  ...
                  <div class="col-sm-8 col-12">
                    <div id="rounded-vertical-pills-tabContent" class="tab-content">
                      <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code19')">
                    <span>Code</span>
                  </button>
            ...
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body rounded-circle-vertical-pills-icon tabs">
                <div class="row mb-4 mt-3">
                  ...
                  <div class="col-sm-8 col-12">
                    <div id="rounded-circle-vertical-pills-tabContent" class="tab-content">
                      <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code20')">
                    <span>Code</span>
                  </button>
          ...
          <div id="tabsVertical" class="col-lg-12 col-12 layout-spacing">
            <div class="statbox panel box box-shadow">
              ...
              <div class="panel-body vertical-pill tabs">
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code21')">
                    <span>Code</span>
                  </button>
              ...
              <div class="panel-body vertical-pill-right tabs">
                <div class="row mb-4 mt-3">
                  <div class="col-sm-9 col-12 order-sm-0 order-1">
                    <div id="v-right-pills-tabContent" class="tab-content">
                      <div
                ...
                <div class="code-section-container show-code">
                  <button type="button" class="btn-default toggle-code-snippet" @click="toggleCode('code22')">
                    <span>Code</span>
                  </button>
