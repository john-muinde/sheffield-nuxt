      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 align-self-center order-md-0 order-1">
            ...
            <p class="">
              Get Instant Answer From Popular Question Asked By Other Users
            </p>
        ...
        <div class="fq-article-section">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
              <div class="card">
                <img
                  src="/assets/images/masonry-blog-style-3.jpeg"
            ...
            <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
              <div class="card">
                <img
                  src="/assets/images/grid-blog-style-2.jpeg"
                  alt="faq-video-tutorials"
                  class="card-img-top"
                />
                <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-md-0 mb-4">
              <div class="card">
                <img
                  src="/assets/images/list-blog-style-3.jpeg"
                  alt="faq-video-tutorials"
                  class="card-img-top"
                />
                <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="card">
                <img
                  src="/assets/images/masonry-blog-style-4.jpeg"
                  alt="faq-video-tutorials"
                  class="card-img-top"
                />
                <div class="card-body">
