...
import { _ as _export_sfc, f as useRoute, u as useRouter, k as useAxios, l as getSegment, g as getProductLink } from './server.mjs';
import { nextTick, useSSRContext, defineComponent, ref, computed, withAsyncContext, mergeProps, withCtx, createTextVNode, toDisplayString, unref } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-fe65a232><nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0" data-v-fe65a232><div class="container d-flex align-items-center" data-v-fe65a232><ol class="breadcrumb" data-v-fe65a232><li class="breadcrumb-item" data-v-fe65a232>`);
      ...
      _push(`</li><li class="breadcrumb-item" data-v-fe65a232>`);
      ...
      _push(`</li><li class="breadcrumb-item active" aria-current="page" data-v-fe65a232>${ssrInterpolate((_c = (_b = unref(productsData)) == null ? void 0 : _b.theCategory) == null ? void 0 : _c.name)}</li></ol></div></nav><div class="page-content" data-v-fe65a232><div class="container" data-v-fe65a232>`);
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fe65a232"]]);

export { ____slug_ as default };
//# sourceMappingURL=_...slug_-BffeVfWW.mjs.map
