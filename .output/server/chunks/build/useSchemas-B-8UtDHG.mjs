...
import { g as getProductLink } from './server.mjs';
...
const useSchemas = (options = { baseUrl: "" }) => {
  const createProductSchema = (product) => {
    ...
    return {
      ...
      image: ((_b = product.product_images) == null ? void 0 : _b.map((img) => assetsSync(img.name))) || [],
      brand: {
        "@type": "Brand",
...
//# sourceMappingURL=useSchemas-B-8UtDHG.mjs.map
