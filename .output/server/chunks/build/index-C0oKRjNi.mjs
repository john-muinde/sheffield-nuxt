    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(segmentsData.value, (segment, segmentIndex) => {
        ...
        ssrRenderList(segment.projects, (project, projectIndex) => {
          _push(`<div class="col-md-2"><article class=""><figure class=""><img${ssrRenderAttr("src", ("assetsSync" in _ctx ? _ctx.assetsSync : unref(assetsSync))(project.main_image_path))} alt="image desc"></figure></article></div>`);
        });
...
//# sourceMappingURL=index-C0oKRjNi.mjs.map
