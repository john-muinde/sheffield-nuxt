...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "main" }, _attrs))} data-v-0f519a93><nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0" data-v-0f519a93><div class="container d-flex align-items-center" data-v-0f519a93><ol class="breadcrumb" data-v-0f519a93><li class="breadcrumb-item" data-v-0f519a93>`);
      ...
      if (((_a = unref(product)) == null ? void 0 : _a.categories_json) && ((_b = unref(product)) == null ? void 0 : _b.categories_json.length) > 0 && ((_c = unref(product)) == null ? void 0 : _c.categories_json[0].parent_name_with_slashes)) {
        _push(`<li class="breadcrumb-item" data-v-0f519a93>`);
      ...
      _push(`<!--]--></li><li class="breadcrumb-item active" aria-current="page" data-v-0f519a93>${ssrInterpolate((_f = unref(product)) == null ? void 0 : _f.name)}</li></ol></div></nav><div class="page-content mt-0" data-v-0f519a93><div class="container" data-v-0f519a93>`);
      if (unref(error)) {
        _push(`<div class="product-error-state" data-v-0f519a93><div class="row justify-content-center" data-v-0f519a93><div class="col-md-8 text-center py-5" data-v-0f519a93><div class="error-icon mb-4" data-v-0f519a93><i class="icon-exclamation-circle text-danger" style="${ssrRenderStyle({ "font-size": "3rem" })}" data-v-0f519a93></i></div><h2 class="error-title mb-3" data-v-0f519a93>Unable to Load Product</h2><p class="error-message text-muted mb-4" data-v-0f519a93> We&#39;re having trouble loading this product&#39;s information. This might be because: </p><ul class="error-reasons text-left mb-4 mx-auto" style="${ssrRenderStyle({ "max-width": "400px" })}" data-v-0f519a93><li data-v-0f519a93>The product may no longer be available</li><li data-v-0f519a93>There might be a temporary connection issue</li><li data-v-0f519a93>The product URL might be incorrect</li></ul><div class="error-actions" data-v-0f519a93><button class="btn btn-primary me-3" data-v-0f519a93> Try Again </button>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
        ...
        _push(`</div><p class="mt-4 small text-muted" data-v-0f519a93> If this problem persists, please contact our support team </p></div></div></div>`);
      } else {
        _push(`<div class="product-details-top" data-v-0f519a93><div class="row" data-v-0f519a93><div class="col-md-5" data-v-0f519a93>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {
          fallback: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="product-gallery-shimmer" data-v-0f519a93${_scopeId}><div class="main-image-shimmer shimmer" data-v-0f519a93${_scopeId}></div><div class="thumbnail-container" data-v-0f519a93${_scopeId}><!--[-->`);
              ssrRenderList(4, (n) => {
                _push2(`<div class="thumbnail-shimmer shimmer" data-v-0f519a93${_scopeId}></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              return [
        ...
        _push(`</div><div class="col-md-7" data-v-0f519a93>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {
          fallback: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="product-details-shimmer" data-v-0f519a93${_scopeId}><div class="shimmer title-shimmer mb-4" data-v-0f519a93${_scopeId}></div><!--[-->`);
              ssrRenderList(3, (n) => {
                _push2(`<div class="shimmer text-shimmer mb-3" data-v-0f519a93${_scopeId}></div>`);
              });
              _push2(`<!--]--><div class="shimmer button-shimmer mt-4" data-v-0f519a93${_scopeId}></div><div class="tabs-shimmer mt-4" data-v-0f519a93${_scopeId}><!--[-->`);
              ssrRenderList(2, (n) => {
                _push2(`<div class="shimmer tab-shimmer" data-v-0f519a93${_scopeId}></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              return [
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0f519a93"]]);

export { ____slug_ as default };
//# sourceMappingURL=_...slug_-3WLlzJfm.mjs.map
