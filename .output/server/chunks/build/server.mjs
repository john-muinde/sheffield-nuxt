...
const unhead_xBD3taP7ou = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    name: void 0 ,
    path: "/kitchen",
    component: component_45stubllrvQLJ14c
  },
  {
    name: void 0 ,
    path: "/kitchen/:pathMatch(.*)",
    component: component_45stubllrvQLJ14c
  }
];
...
const _0_siteConfig_oQ43jVEhcg = /* @__PURE__ */ defineNuxtPlugin({
...
const revive_payload_server_Z1Hj9TTB6O = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_rEHAXyA4gp = /* @__PURE__ */ defineNuxtPlugin(({ $pinia }) => {
...
const plugins = [
  ...
  unhead_xBD3taP7ou,
  plugin$1,
  _0_siteConfig_oQ43jVEhcg,
  revive_payload_server_Z1Hj9TTB6O,
  plugin,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.1592_@parcel+watcher@2.5.0_@types+node@22.10.1_ioredis@5.4.1_magicast@0.3.5_rollup@_awcrso3cov4et7q2a7hnytc2da/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.1592_@parcel+watcher@2.5.0_@types+node@22.10.1_ioredis@5.4.1_magicast@0.3.5_rollup@_awcrso3cov4et7q2a7hnytc2da/node_modules/nuxt/dist/app/components/nuxt-root.vue");
