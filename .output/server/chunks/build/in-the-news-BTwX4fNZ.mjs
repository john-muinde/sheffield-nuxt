...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-a6de84a6><main class="main" data-v-a6de84a6><div class="page-content" data-v-a6de84a6><div class="container" data-v-a6de84a6><div class="row" data-v-a6de84a6><div class="col-lg-10 offset-lg-1 in-the-news-section" data-v-a6de84a6><h2 class="about-us-title" data-v-a6de84a6>In the News</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="icon-long-arrow-left" data-v-a6de84a6${_scopeId}></i><span data-v-a6de84a6${_scopeId}>Back to Media Center</span>`);
          } else {
            return [
      ...
      _push(`<p class="lead about-us-lead text-primary mb-3" data-v-a6de84a6> Media Spotlight: Sheffield Making Waves in the News </p>`);
      if (loading.value) {
      ...
      if (displayedProducts.value.length) {
        _push(`<div class="row justify-content-left" data-v-a6de84a6><!--[-->`);
        ssrRenderList(displayedProducts.value, (product) => {
          _push(`<div class="col-12 col-md-6 col-lg-4 mb-2 blog-item" data-v-a6de84a6><div class="p-6 border rounded" data-v-a6de84a6><div class="position-relative mb-2" style="${ssrRenderStyle({ "height": "216px" })}" data-v-a6de84a6><a target="_blank" class="float-center"${ssrRenderAttr("href", product.url)} data-v-a6de84a6><img class="w-100 h-100 rounded" style="${ssrRenderStyle({ "object-fit": "cover" })}"${ssrRenderAttr("src", ("assets" in _ctx ? _ctx.assets : unref(assets))(product.main_image_path))}${ssrRenderAttr("alt", product.name)} data-v-a6de84a6></a></div><a target="_blank" class="btn btn-primary ml-5 pl-4 mt-2 mb-2 float-center" style="${ssrRenderStyle({ "color": "white" })}"${ssrRenderAttr("href", product.url)} data-v-a6de84a6> Read More <i class="icon-long-arrow-right" data-v-a6de84a6></i></a></div></div>`);
        });
        _push(`<!--]--><div class="col-lg-12 blogs mt-3" data-v-a6de84a6><nav aria-label="Page navigation" data-v-a6de84a6><ul class="pagination justify-content-center" data-v-a6de84a6><li class="${ssrRenderClass([{
          disabled: currentPage.value === 1
        }, "page-item"])}" data-v-a6de84a6>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span aria-hidden="true" data-v-a6de84a6${_scopeId}><i class="icon-long-arrow-left" data-v-a6de84a6${_scopeId}></i></span> Prev `);
            } else {
              return [
        ...
        _push(`<!--]--><li class="page-item-total" data-v-a6de84a6>of ${ssrInterpolate(totalPages.value)}</li><li class="${ssrRenderClass([{
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Next <span aria-hidden="true" data-v-a6de84a6${_scopeId}><i class="icon-long-arrow-right" data-v-a6de84a6${_scopeId}></i></span>`);
            } else {
              return [
...
const inTheNews = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a6de84a6"]]);

export { inTheNews as default };
//# sourceMappingURL=in-the-news-BTwX4fNZ.mjs.map
