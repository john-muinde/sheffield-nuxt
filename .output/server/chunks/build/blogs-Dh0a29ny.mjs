...
import { _ as _sfc_main$1 } from './NuxtImg-CHbwr8LG.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-bb471dca><main class="main" data-v-bb471dca><div class="page-content" data-v-bb471dca><div class="container" data-v-bb471dca><div class="row" data-v-bb471dca><div class="col-lg-10 offset-lg-1" data-v-bb471dca><h2 class="about-us-title" data-v-bb471dca>Blogs</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="icon-long-arrow-left" data-v-bb471dca${_scopeId}></i><span data-v-bb471dca${_scopeId}>Back to Media Center</span>`);
          } else {
            return [
      ...
      _push(`<p class="lead about-us-lead text-primary mb-3" data-v-bb471dca> In-Depth Insights </p>`);
      if (loading.value) {
      ...
      if (displayedPosts.value.length) {
        _push(`<div class="row blogs-main-page-section" data-v-bb471dca><!--[-->`);
        ssrRenderList(displayedPosts.value, (post) => {
          _push(`<div class="entry-item col-sm-6 col-lg-4" data-v-bb471dca><article class="entry entry-grid" data-v-bb471dca><figure class="entry-media entry-gallery" data-v-bb471dca>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_NuxtImg, {
                  src: ("assets" in _ctx ? _ctx.assets : unref(assets))(post.main_image_path),
                  alt: post.name,
                  format: "webp",
                  quality: "80",
                  loading: "lazy",
          ...
          _push(`</figure><div class="entry-body" data-v-bb471dca><h2 class="entry-title" data-v-bb471dca>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            class: "text-primary",
            to: getBlogLink(post.id, post.name)
          }, {
          ...
          _push(`</h2><div class="entry-content" data-v-bb471dca><div class="mb-2" data-v-bb471dca>${ssrInterpolate(getFirstParagraph(post.excerpt))}</div>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` Read More <i class="icon-long-arrow-right" data-v-bb471dca${_scopeId}></i>`);
              } else {
                return [
      ...
      if (displayedPosts.value.length) {
        _push(`<div class="row" data-v-bb471dca><div class="col-md-12" data-v-bb471dca><nav aria-label="Page navigation" data-v-bb471dca><ul class="pagination justify-content-center" data-v-bb471dca><li class="${ssrRenderClass([{
          disabled: currentPage.value === 1
        }, "page-item"])}" data-v-bb471dca>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span aria-hidden="true" data-v-bb471dca${_scopeId}><i class="icon-long-arrow-left" data-v-bb471dca${_scopeId}></i></span> Prev `);
            } else {
              return [
        ...
        _push(`<!--]--><li class="page-item-total" data-v-bb471dca>of ${ssrInterpolate(totalPages.value)}</li><li class="${ssrRenderClass([{
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Next <span aria-hidden="true" data-v-bb471dca${_scopeId}><i class="icon-long-arrow-right" data-v-bb471dca${_scopeId}></i></span>`);
            } else {
              return [
...
const blogs = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bb471dca"]]);

export { blogs as default };
//# sourceMappingURL=blogs-Dh0a29ny.mjs.map
