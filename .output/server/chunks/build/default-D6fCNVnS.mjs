...
import { useSSRContext, defineComponent, ref, computed, watchEffect, mergeProps, unref, reactive, withCtx, openBlock, createBlock, Fragment, renderList, createVNode, createTextVNode, toDisplayString, withAsyncContext, watch } from 'vue';
import { _ as _export_sfc, f as useRoute, k as useAxios, l as getSegment, J as useAuthStore, g as getProductLink } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "the_main_div" }, _attrs))} data-v-7ef50cba>`);
      if (!isHomePage.value) {
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7ef50cba"]]);

export { _default as default };
//# sourceMappingURL=default-D6fCNVnS.mjs.map
