...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { createFAQSchema, createOrganizationSchema, createServiceAreasSchema } = useSchemas();
    ...
    [
      ...
      createFAQSchema([
        {
          question: "What commercial kitchen equipment services does Sheffield provide?",
          answer: "Sheffield provides complete commercial kitchen solutions including design, equipment supply, installation, maintenance, and custom fabrication. We serve restaurants, hotels, hospitals, schools, and industrial facilities."
        },
        {
          question: "Which areas does Sheffield serve in East Africa?",
          answer: "Sheffield serves all major cities in East Africa including Nairobi, Mombasa, Kisumu, Kampala, Dar es Salaam, and Kigali, with additional coverage across Kenya, Uganda, Tanzania, and Rwanda."
        }
      ])
    ];
    useHead({
...
//# sourceMappingURL=default-ZaXt4LtL.mjs.map
