...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-eebf619f><main class="main" data-v-eebf619f><div class="page-content" data-v-eebf619f><div class="container" data-v-eebf619f><div class="row" data-v-eebf619f><div class="col-lg-10 offset-lg-1 gallery-main-page-section" data-v-eebf619f><h2 class="about-us-title" data-v-eebf619f>Gallery</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="icon-long-arrow-left" data-v-eebf619f${_scopeId}></i><span data-v-eebf619f${_scopeId}>Back to Media Center</span>`);
          } else {
            return [
      ...
      _push(`<p class="lead about-us-lead text-primary mb-3" data-v-eebf619f> Journey Through the Lens: Our Story in Pictures </p>`);
      ...
      if (displayedProducts.value.length) {
        _push(`<div class="row mt-2" data-v-eebf619f><!--[-->`);
        ssrRenderList(displayedProducts.value, (product) => {
          _push(`<div class="entry-item col-sm-6 col-lg-4" data-v-eebf619f><article class="entry entry-mask" data-v-eebf619f><figure class="entry-media entry-gallery" data-v-eebf619f>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          _push(`</figure><div class="entry-body" data-v-eebf619f><div class="entry-meta" data-v-eebf619f><span class="meta-separator" data-v-eebf619f>|</span></div><h2 class="entry-title" data-v-eebf619f>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: getBlogLink(product.id, product.name)
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          _push(`</h2><div class="entry-cats mt-1" data-v-eebf619f><b style="${ssrRenderStyle({ "background-color": "#c02434", "padding": "5px" })}" data-v-eebf619f>${ssrInterpolate(product.gallery_type)}</b></div></div></article></div>`);
        });
        _push(`<!--]--><div class="col-lg-12 mt-3" data-v-eebf619f><nav aria-label="Page navigation" data-v-eebf619f><ul class="pagination justify-content-center" data-v-eebf619f><!--[-->`);
        ssrRenderList((_a = pagination.value) == null ? void 0 : _a.links, (page, index) => {
          _push(`<li class="${ssrRenderClass([{ active: page.active }, "page-item"])}" data-v-eebf619f>`);
          if (page.url && Number.isInteger(Number(page.label))) {
            _push(`<a class="page-link" data-v-eebf619f>${ssrInterpolate(page.label)}</a>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
...
const gallery = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eebf619f"]]);

export { gallery as default };
//# sourceMappingURL=gallery-8Gp5amyg.mjs.map
