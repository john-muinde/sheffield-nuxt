import { useSSRContext, ref, reactive, watch, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, createTextVNode, computed, nextTick } from 'vue';
...
import { _ as __nuxt_component_0$1 } from './nuxt-link-b8Qz_wJG.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(TransitionChild), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="fixed inset-0 bg-black bg-opacity-75" data-v-a1a70570${_scopeId3}></div>`);
                      } else {
                        return [
                  ...
                  _push3(`<div class="fixed inset-0 overflow-y-auto" data-v-a1a70570${_scopeId2}><div class="flex min-h-full items-center justify-center p-4" data-v-a1a70570${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(TransitionChild), {
                    enter: "duration-300 ease-out",
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(DialogPanel), {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="relative aspect-video" data-v-a1a70570${_scopeId4}>`);
                              if (isYouTubeVideo.value) {
                                _push5(`<div class="plyr__video-embed h-full" data-v-a1a70570${_scopeId4}><iframe${ssrRenderAttr("src", `https://www.youtube.com/embed/${getYoutubeId(__props.videoUrl)}?autoplay=1`)} allowfullscreen allow="autoplay" class="w-full h-full rounded-2xl" data-v-a1a70570${_scopeId4}></iframe></div>`);
                              } else {
                                _push5(`<div class="h-full" data-v-a1a70570${_scopeId4}><video class="plyr-video w-full h-full rounded-2xl" crossorigin data-v-a1a70570${_scopeId4}><source${ssrRenderAttr("src", __props.videoUrl)} type="video/mp4" data-v-a1a70570${_scopeId4}></video></div>`);
                              }
                              _push5(`<button class="absolute top-4 right-4 p-2 rounded-full bg-black bg-opacity-50 text-white hover:bg-opacity-75 transition-colors" data-v-a1a70570${_scopeId4}><span class="sr-only" data-v-a1a70570${_scopeId4}>Close</span><svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-a1a70570${_scopeId4}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-a1a70570${_scopeId4}></path></svg></button></div>`);
                            } else {
                              return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a1a70570"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_VideoPopup = __nuxt_component_0;
...
//# sourceMappingURL=index-oeXk3ML9.mjs.map
