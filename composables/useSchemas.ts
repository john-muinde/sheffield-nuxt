// composables/useSchemas.ts

interface SchemaOptions {
  baseUrl: string;
}

export const useSchemas = (options: SchemaOptions = { baseUrl: "" }) => {
  const createProductSchema = (product: any) => {
  ...
  const createOrganizationSchema = () => {
    return {
      ...
      brand: {
        ...
        description:
          "Leading provider of commercial kitchen and refrigeration solutions in East Africa",
      },
      award: [
  ...
  const createVideoSchema = (video: any) => {
    return {
      "@context": "https://schema.org",
      "@type": "VideoObject",
      name: video.name,
  ...
  const createBlogListingSchema = (articles: any[]) => {
    return {
      "@context": "https://schema.org",
      "@type": "ItemList",
  ...
  const createFAQSchema = (faqs: any[]) => {
    return {
      "@context": "https://schema.org",
      "@type": "FAQPage",
  ...
  const createServiceAreasSchema = (cities: string[]) => {
    return {
      "@context": "https://schema.org",
      "@type": "Service",
